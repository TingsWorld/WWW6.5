...
contract AutomatedMarketMaker is ERC20 {
    ...
    event TokensSwapped(address indexed trader, address tokenIn, uint256 amountIn, address tokeOut, uint256 amountOut);

    // 后面两个_name和_symbol是自行发行的LP代币的名称和简写
...
// 0x08F1D092444a7225e1a501c9E296c4C0165F755E