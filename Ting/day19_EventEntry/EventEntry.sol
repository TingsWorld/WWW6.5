...
contract EventEntry {
    ...
    constructor(string memory _eventName, uint256 _maxAttendees) {
        ...
        emit EventCreated(_eventName, eventDate, _maxAttendees);
    }
    ...
    function verifySignature(address _attendee, bytes memory _signature) private  view returns (bool){
    ...
    function checkIn(bytes memory _signature) external {
        ...
        require(verifySignature(msg.sender, _signature), "Invalild signature");
