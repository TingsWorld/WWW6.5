...
contract VaultManager{
    ...
    function nameBox(address boxAddress, string memory name ) external onlyBoxOwner(boxAddress){
    ...
    // function getBoxUser(address boxAddress) external view returns (address){
    //     IDepositBox box = IDepositBox(boxAddress);
    //     return (box.getOwner());
    // }
    ...
    function getSecret(address boxAddress) external view  onlyBoxOwner(boxAddress) returns(string memory){
        IDepositBox box = IDepositBox(boxAddress);
