...
contract CropInsurance is Ownable{
    ...
    function purchaseInsurance() external payable{
        ...
        uint256 premiunInEth = (INSURANCE_PAYOUT_USD * 1e18) / ethPrice;

        require(msg.value >= premiunInEth, "Insufficient premium amount");
    ...
    function checkRainfallAndClaim() external {
        require(hasInsurance[msg.sender], "No active indurance");
...
//0x992277F0207E67AEEF20beb2Cb6221295425656B